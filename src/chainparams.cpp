...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.dancoin.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.dancointools.com", true);
        vSeeds.emplace_back("dnsseed.dancoinpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.dancointools.com", true);
        vSeeds.emplace_back("seed-b.dancoin.loshan.co.uk", true);
