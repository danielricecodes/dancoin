...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s dancoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  dancoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dancoin transaction") + "\n" +
              "  dancoin-tx [options] -create [commands]   " + _("Create hex-encoded dancoin transaction") + "\n" +
              "\n";
