...
const char * const BITCOIN_CONF_FILENAME = "dancoin.conf";
const char * const BITCOIN_PID_FILENAME = "dancoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Dancoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Dancoin";
#else
    // Unix
    return pathRet / ".dancoin";
#endif
#endif
}
