...
LITECOIND=${LITECOIND:-$SRCDIR/dancoind}
LITECOINCLI=${LITECOINCLI:-$SRCDIR/dancoin-cli}
LITECOINTX=${LITECOINTX:-$SRCDIR/dancoin-tx}
LITECOINQT=${LITECOINQT:-$SRCDIR/qt/dancoin-qt}
